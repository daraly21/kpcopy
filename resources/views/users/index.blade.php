    ...
    <div class="py-6" x-data="userManager()">
        ...
        <div x-show="openModal" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50" x-cloak>
            <div class="bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4" @click.away="openModal = false">
                <div class="p-6">
                    <h3 class="text-xl font-bold mb-4 flex items-center" x-text="isEdit ? 'Edit Pengguna' : 'Tambah Pengguna'">
                    ...
                    <form :action="formAction" method="POST" @submit="validateAndSubmit">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <!-- Password -->
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1" x-text="isEdit ? 'Password (opsional)' : 'Password *'"></label>
                            ...
                            <!-- Konfirmasi Password -->
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1" x-text="isEdit ? 'Konfirmasi Password (opsional)' : 'Konfirmasi Password *'"></label>
                            ...
                            <div x-show="form.role == 3">
                                ...
                                <div x-show="errors.subject_id" class="text-red-500 text-xs mt-1" x-text="errors.subject_id"></div>
                            </div>
